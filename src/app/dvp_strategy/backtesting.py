...
class DVPBacktestingEngine:
    ...
    def __init__(self) -> None:
        """"""
        self.vt_symbol_stock = None
        self.vt_symbol: str = ""
        self.symbol: str = ""
        self.symbol_stock: str = ""
        ...
        self.strategy_class: Type[DVPTemplate] = None
        self.strategy: DVPTemplate = None
        self.tick: TickData
        self.bar: BarData
    ...
    def set_parameters(
        ...
        self.vt_symbol_stock = vt_symbol_stock
        ...
        self.symbol_stock, exchange_str = self.vt_symbol_stock.split(".")
    ...
    def cancel_order(self, strategy: DVPTemplate, vt_orderid: str) -> None:
        """
    ...
    def cancel_stop_order(self, strategy: DVPTemplate, vt_orderid: str) -> None:
        """"""
    ...
    def cancel_limit_order(self, strategy: DVPTemplate, vt_orderid: str) -> None:
        """"""
    ...
    def cancel_all(self, strategy: DVPTemplate) -> None:
        """
    ...
    def write_log(self, msg: str, strategy: DVPTemplate = None) -> None:
        """
        Write log message.
        """
    ...
    def send_email(self, msg: str, strategy: DVPTemplate = None) -> None:
        """
        Send email to default receiver.
        """
        pass

    def sync_strategy_data(self, strategy: DVPTemplate) -> None:
        """
    ...
    def get_pricetick(self, strategy: DVPTemplate) -> float:
        """
        Return contract pricetick data.
        """
        return self.pricetick

    def get_size(self, strategy: DVPTemplate) -> int:
        """
        Return contract size data.
        """
        return self.size

    def put_strategy_event(self, strategy: DVPTemplate) -> None:
        """
...
def load_tick_data(
        ...
        backtester_date: datetime,
        output,
) -> [List[TickData], List[TickData]]:
    """"""
    datafeed = get_datafeed()
    bond_req: HistoryRequest = HistoryRequest(symbol=symbol, exchange=exchange,
                                              start=backtester_date,
                                              interval=Interval.TICK)
    stock_req: HistoryRequest = HistoryRequest(symbol=symbol_stock, exchange=exchange,
                                               start=backtester_date,
                                               interval=Interval.TICK)
    bond_data = datafeed.query_tick_history(bond_req, output)
    stock_data = datafeed.query_tick_history(stock_req, output)
